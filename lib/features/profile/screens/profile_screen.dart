...
import 'package:ride_sharing_user_app/features/settings/screens/privacy_policy.dart';
            ...
            body: SingleChildScrollView(
              ...
              child: Column(children:  [
                ...
                ProfileMenuItem(title: 'privacy_policy', icon: Images.privacyPolicyIcon,
                  onTap: () => Get.to(() =>  PrivacyPolicyPage()//PolicyScreen(htmlType: HtmlType.privacyPolicy,
                ...
                ProfileMenuItem(title: 'terms_and_condition', icon: Images.termsAndCondition,
                  onTap: () => Get.to(() => TermsAndConditionsPage(), //PolicyScreen(htmlType: HtmlType.termsAndConditions,
