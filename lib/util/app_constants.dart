...
class AppConstants {
  static const String appName = 'Maylon';
  static const String baseUrl = 'https://auth.maylon.com.br';
  ...
  static List<LanguageModel> languages = [
    LanguageModel(imageUrl: Images.brflag, languageName:'Portuguese', countryCode: 'BR', languageCode: 'pt'),
